 ...
 * % java Maze 61
 * <p>
 * Note: this program generalizes nicely to finding a bigO.src.practice.random tree
 * in a graph.
 ******************************************************************************/
...
public class Maze {
    ...
    private void generate(int x, int y) {
        ...
        while (!visited[x][y + 1] || !visited[x + 1][y] || !visited[x][y - 1] || !visited[x - 1][y]) {
            ...
            // pick bigO.src.practice.random neighbor (could use Knuth's trick instead)
            while (true) {
...
/*
        // delete some bigO.src.practice.random walls
        for (int i = 0; i < n; i++) {
        ...
        // add some bigO.src.practice.random walls
        for (int i = 0; i < 10; i++) {
